...
\begin{columns} % See Section 4.4
    ...
    \begin{tikzfigure}
    \includegraphics[width=0.95\linewidth]{JOSS-logo}
    \end{tikzfigure}
    ...
    \begin{tikzfigure}
    \includegraphics[width=0.66\linewidth]{JOSS-flowchart}
    \end{tikzfigure}
...
\begin{columns}
    ...
    \begin{enumerate}[leftmargin=1cm,topsep=0pt,noitemsep]
        ...
        \item NCSA, CS, GSLIS, ECE, University of Illinois at Urbana--Champaign
